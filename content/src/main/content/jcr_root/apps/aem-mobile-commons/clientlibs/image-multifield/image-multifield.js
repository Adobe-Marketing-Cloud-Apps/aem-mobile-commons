(function () {
    var DATA_EAEM_NESTED = "data-eaem-nested",
        ...
        SLING_RESOURCETYPE = "./sling:resourceType",
        IMAGE_RT = "foundation/components/image",
    ...
    function collectImageFields($form, $fieldSet, counter){
        ...
        $fields.each(function (j, field) {
            ...
            var RTPath =  $fieldSet.data("name") + "/" + (counter + 1) + "/" + SLING_RESOURCETYPE;
            ...
            $('<input />').attr('type', 'hidden').attr('name', RTPath )
                .attr('value', IMAGE_RT ).appendTo($form);
